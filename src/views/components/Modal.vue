        ...
        <div v-show="$props.isShowing" class="fixed inset-0 z-10 overflow-y-auto">
            <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20">
                <div class="fixed inset-0 transition-opacity" aria-hidden="true">
                    <div class="absolute inset-0 bg-gray-800 opacity-75" @click="onClose"></div>
                </div>
                <div class="m-8 inline-block align-middle w-full max-w-2xl transform transition-all" :class="class">
